...
WS_TYPE_FLOORS_LIST = f"{DOMAIN}/floors/list"
WS_TYPE_FLOORS_CREATE = f"{DOMAIN}/floors/create"
WS_TYPE_FLOORS_UPDATE = f"{DOMAIN}/floors/update"
WS_TYPE_FLOORS_DELETE = f"{DOMAIN}/floors/delete"
